class Blog:
    ...
    def log_user_in(self):
        ...
        for user in self.users:
            # Chek if that user has the same username and password as the inputs
            ...
            def log_user_out(self):
                # Change the current_user attribute from the user to Nnoe
                self.current_user = None
            ...
            def view_posts(self):
                ...
                def edit_post(self, post_id):
                    ...
                    if post:
                        ...
                        if self.current_user is not None and self.current_user ==post.auther:
                            print(post)
...
def run_blog():
    ...
    while True:
        ...
        # If there is a current user (aka a logged in user)
            ...
            print("1. Log Out\n2. Create New Post=n3. View All Posts\n4. View Single Post\n5. Edit a Post\n6. Delete a Post")
            to_do = input('Which option would you like to do? ')
